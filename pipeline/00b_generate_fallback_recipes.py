...
ALL_RECIPES = {
        ...
        "steps": [
            {
             ...
             "common_mistakes": ["insufficient marination time (under 2 hrs)", "not scoring chicken pieces"],
            ...
            },
            {
             ...
             "ingredient_state": {"rice": "dry grains soaking in water"},
             "expected_visual_features": ["white rice submerged in water", "water turning slightly starchy"],
             "expected_audio": "water pouring, gentle swishing",
             "common_mistakes": ["not washing rice enough", "soaking too long (grains break)"],
             "recovery_actions": ["drain and rinse again", "reduce parboil time if over-soaked"]
            },
            {
             ...
             "ingredient_state": {"rice": "70% cooked — grains elongated but firm in center", "water": "starchy, rolling boil"},
             "expected_visual_features": ["white elongated grains", "rolling boil", "whole spices floating"],
             "expected_audio": "vigorous bubbling, water boiling",
             "common_mistakes": ["overcooking rice past 70%", "not draining immediately"],
             "recovery_actions": ["spread rice on tray to stop cooking", "rinse with cold water"]
            },
            {
             ...
             "ingredient_state": {"onions": "thinly sliced, turning dark golden and crispy", "oil": "hot, shimmering"},
             ...
             "common_mistakes": ["uneven slicing", "removing too early (pale)", "oil not hot enough"],
             "recovery_actions": ["use mandoline for even slices", "fry in smaller batches"]
            },
            {
             ...
             "expected_visual_features": ["red-orange chicken arranged at bottom of handi"],
             "expected_audio": "placement sounds, wet slapping",
             "common_mistakes": ["uneven distribution", "discarding excess marinade"],
             "recovery_actions": ["rearrange evenly", "pour all marinade over chicken"]
            },
            {
             ...
             "visible_objects": ["handi with chicken", "parboiled rice", "spoon"],
             "ingredient_state": {"rice": "70% cooked, drained", "chicken": "raw marinated, underneath"},
             "expected_visual_features": ["white rice layer covering red chicken layer"],
             "expected_audio": "gentle placing sounds",
             "common_mistakes": ["pressing rice down", "uneven layer thickness"],
             "recovery_actions": ["fluff rice gently with fork", "redistribute for even coverage"]
            },
            {
             ...
             "visible_objects": ["saffron milk", "ghee", "fried onions", "mint leaves", "coriander"],
             "ingredient_state": {"saffron": "dissolved in warm milk, golden", "ghee": "melted", "onions": "crispy fried birista"},
             "expected_visual_features": ["golden saffron streaks on white rice", "green herbs", "brown onion strands"],
             "expected_audio": "drizzling liquid, sprinkling",
             "common_mistakes": ["too little saffron", "not warming milk before adding saffron"],
             "recovery_actions": ["add more saffron milk", "steep saffron in warm milk 10 min"]
            },
            {
             ...
             "ingredient_state": {"dough": "pliable wheat flour rope pressed around lid edge"},
             "expected_visual_features": ["dough strip sealing lid-pot gap", "no steam escaping"],
             "expected_audio": "pressing/sealing sounds, then silence",
             "common_mistakes": ["gaps in dough seal", "dough too dry (cracks)"],
             "recovery_actions": ["press firmly and patch gaps", "add water to dough if cracking"]
            },
            {
             ...
             "visible_objects": ["sealed handi on stove", "tawa underneath (optional)"],
             "ingredient_state": {"rice": "cooking from 70% to done via steam", "chicken": "cooking from raw to done via steam"},
             "expected_visual_features": ["sealed pot on stove", "no steam escaping"],
             "expected_audio": "initial hissing, then very quiet on low heat",
             "common_mistakes": ["opening lid during dum", "heat too high throughout (bottom burns)"],
             "recovery_actions": ["never open \u2014 trust the process", "place tawa under handi for heat diffusion"]
            },
            {
             ...
             "ingredient_state": {"rice": "fully cooked, fluffy, saffron-streaked", "chicken": "fully cooked, tender"},
             "expected_visual_features": ["bicolor rice (white and gold)", "tender chicken visible", "steam rising"],
             "expected_audio": "seal cracking, steam release, gentle mixing",
             "common_mistakes": ["mixing too vigorously (breaks grains)", "not resting"],
             "recovery_actions": ["use flat spatula, fold gently from edges", "rest minimum 5-10 min"]
            }
        ],
    ...
    "Kolkata": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["heavy-bottomed degchi", "frying pan (for potatoes)", "pot (for boiling eggs)", "strainer"],
        "marination_strategy": "wet yogurt-based, 1-2 hrs, dairy (yogurt) + mild spices (nutmeg, mace)",
        "spice_intensity": "low",
        "distinguishing_features": [
        ...
        "steps": [
            {
             ...
             "visible_objects": ["mixing bowl", "chicken pieces", "yogurt/marinade", "spice powders"],
             "ingredient_state": {"chicken": "raw, cut into pieces", "marinade": "mixed wet paste coating chicken"},
             "expected_visual_features": ["chicken coated in colored marinade", "spice paste visible on pieces"],
             "expected_audio": "mixing and squelching sounds",
             "common_mistakes": ["insufficient marination time", "uneven coating"],
             "recovery_actions": ["extend marination in refrigerator", "remix and re-coat all pieces"]
            },
            {
             ...
             "visible_objects": ["cooking pot/pan", "chicken pieces", "ghee", "onions", "spices"],
             "ingredient_state": {"chicken": "cooking in masala, browning and releasing juices"},
             "expected_visual_features": ["chicken browning", "gravy thickening", "oil separating from masala"],
             "expected_audio": "sizzling, bubbling masala",
             "common_mistakes": ["heat too high (masala burns)", "not cooking until oil separates"],
             "recovery_actions": ["reduce heat", "cook until oil separates from masala (sign of doneness)"]
            },
            {
             ...
             "visible_objects": ["pot", "boiling water", "potatoes", "eggs"],
             "ingredient_state": {"potatoes": "boiling, becoming tender", "eggs": "hard-boiling"},
             "expected_visual_features": ["boiling water", "potatoes/eggs submerged"],
             "expected_audio": "bubbling water",
             "common_mistakes": ["overcooking potatoes (too soft)", "not frying potatoes golden after boiling"],
             "recovery_actions": ["test with fork", "fry until deep golden after boiling"]
            },
            {
             ...
             "visible_objects": ["bowl", "rice", "water"],
             "ingredient_state": {"rice": "dry grains soaking in water, absorbing moisture"},
             "expected_visual_features": ["white rice submerged in water", "water turning slightly starchy"],
             "expected_audio": "water pouring, gentle swishing",
             "common_mistakes": ["not washing rice enough (excess starch)", "soaking too long (grains break)"],
             "recovery_actions": ["drain and rinse again", "reduce parboil time if over-soaked"]
            },
            {
             ...
             "visible_objects": ["cooking pot", "chicken"],
             "ingredient_state": {"chicken": "being layered in pot"},
             "expected_visual_features": ["distinct layers visible in pot"],
             "expected_audio": "placing/spreading sounds",
             "common_mistakes": ["uneven distribution", "pressing down (compacts, blocks steam)"],
             "recovery_actions": ["redistribute evenly", "keep layers loose and fluffy"]
            },
            {
             ...
             "visible_objects": ["cooking pot", "fried potatoes", "boiled eggs"],
             "ingredient_state": {"potatoes": "fried golden", "eggs": "hard-boiled, halved"},
             "expected_visual_features": ["golden potato pieces", "white egg halves arranged"],
             "expected_audio": "placing sounds",
             "common_mistakes": ["potatoes not golden enough"],
             "recovery_actions": ["ensure potatoes are properly fried before adding"]
            },
            {
             ...
             "visible_objects": ["cooking pot", "basmati rice"],
             "ingredient_state": {"basmati rice": "being layered in pot"},
             "expected_visual_features": ["distinct layers visible in pot"],
             "expected_audio": "placing/spreading sounds",
             "common_mistakes": ["uneven distribution", "pressing down (compacts, blocks steam)"],
             "recovery_actions": ["redistribute evenly", "keep layers loose and fluffy"]
            },
            {
             ...
             "visible_objects": ["saffron milk", "ghee", "fried onions", "herbs"],
             "ingredient_state": {"saffron": "dissolved in warm milk, golden", "ghee": "melted"},
             "expected_visual_features": ["golden saffron streaks", "green herb specks", "aromatic steam"],
             "expected_audio": "drizzling liquid, sprinkling",
             "common_mistakes": ["too little saffron/ghee", "not steeping saffron first"],
             "recovery_actions": ["steep saffron in warm milk 10 min", "be generous with ghee"]
            },
            {
             ...
             "visible_objects": ["sealed pot on stove"],
             "ingredient_state": {"contents": "cooking via trapped steam, flavors melding"},
             "expected_visual_features": ["sealed pot, no steam escaping", "slight aroma building"],
             "expected_audio": "initial hissing/steam, then very quiet on low heat",
             "common_mistakes": ["opening lid during dum (releases steam)", "heat too high (bottom burns)"],
             "recovery_actions": ["never open lid \u2014 trust the process", "place tawa underneath for heat diffusion"]
            },
            {
             ...
             "visible_objects": ["cooking pot", "serving dish", "accompaniments"],
             "ingredient_state": {"rice": "fully cooked, fluffy", "chicken": "fully cooked, tender"},
             "expected_visual_features": ["fluffy rice with visible layers", "tender chicken", "steam rising"],
             "expected_audio": "gentle mixing, steam release",
             "common_mistakes": ["mixing too vigorously (breaks rice grains)", "not resting before serving"],
             "recovery_actions": ["fold gently from edges", "rest 5-10 min minimum"]
            }
        ],
    ...
    "Lucknowi": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["heavy degchi with sealed lid", "stock pot (for yakhni)", "muslin cloth (for potli)", "strainer"],
        "marination_strategy": "wet yogurt-based, 1 hr, dairy (yogurt) + mild spices",
        "spice_intensity": "low",
        "distinguishing_features": [
        ...
        "steps": [
            {
             ...
             "visible_objects": ["stock pot", "chicken pieces/bones", "whole spices", "onion"],
             "ingredient_state": {"stock": "simmering, extracting flavors", "chicken": "cooking in spiced stock"},
             "expected_visual_features": ["clear to slightly cloudy broth", "whole spices and onion floating"],
             "expected_audio": "gentle simmering, soft bubbling",
             "common_mistakes": ["boiling too vigorously (cloudy stock)", "too few spices"],
             "recovery_actions": ["reduce to gentle simmer", "strain carefully"]
            },
            {
            ...
            },
            {
             ...
             "visible_objects": ["large pot", "boiling water", "rice", "whole spices", "strainer"],
             "ingredient_state": {"rice": "75% cooked — grains elongated but firm in center", "water": "starchy, rolling boil"},
             "expected_visual_features": ["elongated rice grains", "rolling boil", "whole spices floating"],
             "expected_audio": "vigorous bubbling, boiling water",
             "common_mistakes": ["overcooking rice past 75%", "not draining immediately"],
             "recovery_actions": ["spread rice on tray to stop cooking", "rinse with cold water"]
            },
            {
             ...
             "visible_objects": ["mixer/grinder", "spice ingredients", "bowl"],
             "ingredient_state": {"cardamom": "being ground into paste", "cloves": "being ground into paste", "cinnamon": "being ground into paste"},
             "expected_visual_features": ["thick green/red paste forming"],
             "expected_audio": "grinding/blending sounds",
             "common_mistakes": ["paste too coarse", "not enough liquid for smooth grinding"],
             "recovery_actions": ["grind longer", "add small amount of water"]
            },
            {
             ...
             "visible_objects": ["cooking pot", "chicken", "basmati rice"],
             "ingredient_state": {"chicken": "being layered in pot", "basmati rice": "being layered in pot"},
             "expected_visual_features": ["distinct layers visible in pot"],
             "expected_audio": "placing/spreading sounds",
             "common_mistakes": ["uneven distribution", "pressing down (compacts, blocks steam)"],
             "recovery_actions": ["redistribute evenly", "keep layers loose and fluffy"]
    ...
    "Malabar": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["heavy uruli or cheena chatti", "grinding stone/mixer", "frying pan (for cashews)", "strainer"],
        "marination_strategy": "wet coconut-based, pre-cooked in masala paste with coconut milk",
        "spice_intensity": "medium",
        "distinguishing_features": [
        ...
        "steps": [
            {
             ...
             "visible_objects": ["mixer/grinder", "spice ingredients", "bowl"],
             "ingredient_state": {"ginger-garlic paste": "being ground into paste", "green chili": "being ground into paste", "fennel seeds": "being ground into paste"},
             "expected_visual_features": ["thick green/red paste forming"],
             "expected_audio": "grinding/blending sounds",
             "common_mistakes": ["paste too coarse", "not enough liquid for smooth grinding"],
             "recovery_actions": ["grind longer", "add small amount of water"]
            },
            {
             ...
             "visible_objects": ["cooking pot/pan", "chicken pieces", "ghee/oil", "onions", "spices"],
             "ingredient_state": {"chicken": "cooking in masala, browning and releasing juices"},
             "expected_visual_features": ["chicken browning", "gravy thickening", "oil separating from masala"],
             "expected_audio": "sizzling, bubbling masala",
             "common_mistakes": ["heat too high (masala burns)", "not cooking until oil separates"],
            ...
            },
            {
             ...
             "visible_objects": ["large pot", "boiling water", "rice", "whole spices", "strainer"],
             "ingredient_state": {"rice": "80% cooked — grains elongated but firm in center", "water": "starchy, rolling boil"},
             "expected_visual_features": ["elongated rice grains", "rolling boil", "whole spices floating"],
             "expected_audio": "vigorous bubbling, boiling water",
             "common_mistakes": ["overcooking rice past 80%", "not draining immediately"],
             "recovery_actions": ["spread rice on tray to stop cooking", "rinse with cold water"]
            },
            {
             ...
             "visible_objects": ["kadhai/deep pan", "sliced onions", "hot oil", "slotted spoon"],
             "ingredient_state": {"onions": "thinly sliced, turning golden-brown and crispy", "oil": "hot, shimmering"},
             "expected_visual_features": ["golden-brown crispy onion strands", "oil bubbling around onions"],
             "expected_audio": "continuous sizzling, crackling",
             "common_mistakes": ["uneven slicing", "removing too early (pale, not crispy)", "oil not hot enough"],
             "recovery_actions": ["use mandoline for even slices", "fry in smaller batches"]
            },
            {
             ...
             "visible_objects": ["frying pan", "ghee", "cashews", "raisins"],
             "ingredient_state": {"nuts": "toasting in ghee, turning golden", "raisins": "plumping up"},
             "expected_visual_features": ["golden cashews", "plump raisins", "ghee bubbling gently"],
             "expected_audio": "gentle sizzling",
             "common_mistakes": ["burning nuts (they brown quickly)", "not watching closely"],
             "recovery_actions": ["use low heat, stir constantly", "remove immediately when golden"]
            },
            {
    ...
    "Sindhi": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["heavy-bottomed pot (deg)", "frying pan (for potatoes)", "strainer", "mixing bowl"],
        "marination_strategy": "wet yogurt-based, 1-2 hrs, dairy (yogurt) + heavy red chili + cumin",
        "spice_intensity": "high",
        "distinguishing_features": [
        ...
        "steps": [
            ...
            },
            {
             ...
             "visible_objects": ["cooking vessel"],
             "ingredient_state": {},
             "expected_visual_features": ["cooking in progress"],
             "expected_audio": "cooking sounds",
             "common_mistakes": ["timing incorrect"],
             "recovery_actions": ["adjust timing and check frequently"]
            },
            {
             ...
             "visible_objects": ["frying pan", "potato pieces", "hot oil"],
             "ingredient_state": {"potatoes": "peeled, cut, frying until golden", "oil": "hot"},
             "expected_visual_features": ["golden-brown potato pieces", "oil bubbling"],
             "expected_audio": "sizzling oil, crackling",
             "common_mistakes": ["potatoes not golden enough", "oil too cold"],
             "recovery_actions": ["fry longer until deep golden", "increase oil temperature"]
            },
            {
            ...
            },
            {
             ...
             "visible_objects": ["cooking pot", "chicken", "potato"],
             "ingredient_state": {"chicken": "being layered in pot", "potato": "being layered in pot"},
             "expected_visual_features": ["distinct layers visible in pot"],
             "expected_audio": "placing/spreading sounds",
             "common_mistakes": ["uneven distribution", "pressing down (compacts, blocks steam)"],
             "recovery_actions": ["redistribute evenly", "keep layers loose and fluffy"]
            },
            {
             ...
             "visible_objects": ["cooking pot", "basmati rice", "saffron", "onion"],
             "ingredient_state": {"basmati rice": "being layered in pot", "saffron": "being layered in pot", "onion": "being layered in pot"},
             "expected_visual_features": ["distinct layers visible in pot"],
             "expected_audio": "placing/spreading sounds",
             "common_mistakes": ["uneven distribution", "pressing down (compacts, blocks steam)"],
             "recovery_actions": ["redistribute evenly", "keep layers loose and fluffy"]
    ...
    "Muradabadi": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["heavy degchi", "stock pot (for yakhni)", "frying pan", "strainer"],
        "marination_strategy": "yakhni-based, no separate marination \u2014 chicken boiled in spiced stock then fried in mustard oil",
        "spice_intensity": "medium",
        "distinguishing_features": [
        ...
        "steps": [
            ...
            },
            {
             ...
             "visible_objects": ["cooking pot/pan", "chicken pieces", "oil", "onions", "spices"],
             "ingredient_state": {"chicken": "cooking in masala, browning and releasing juices"},
             "expected_visual_features": ["chicken browning", "gravy thickening", "oil separating from masala"],
             "expected_audio": "sizzling, bubbling masala",
             "common_mistakes": ["heat too high (masala burns)", "not cooking until oil separates"],
    ...
    "Delhi": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["large deg (cauldron)", "kadhai (for frying onions)", "strainer", "mixing bowl"],
        "marination_strategy": "wet yogurt-based, 2 hrs, dairy (yogurt) + garam masala + ginger-garlic",
        "spice_intensity": "medium-high",
        "distinguishing_features": [
    ...
    "Andhra": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["heavy-bottomed pot", "mixer/grinder (for chili paste)", "kadhai", "strainer"],
        "marination_strategy": "wet yogurt-based, 1 hr, dairy (yogurt) + heavy red & green chili + turmeric",
        "spice_intensity": "high",
        "distinguishing_features": [
        ...
        "steps": [
            ...
            },
            {
             ...
             "visible_objects": ["mixer/grinder", "spice ingredients", "bowl"],
             "ingredient_state": {"green chili": "being ground into paste", "mint": "being ground into paste", "coriander": "being ground into paste"},
             "expected_visual_features": ["thick green/red paste forming"],
             "expected_audio": "grinding/blending sounds",
             "common_mistakes": ["paste too coarse", "not enough liquid for smooth grinding"],
             "recovery_actions": ["grind longer", "add small amount of water"]
    ...
    "Ambur": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["earthen pot or heavy pan", "stock pot (for rice in meat stock)", "strainer"],
        "marination_strategy": "wet curd-based, 1 hr, dairy (yogurt) + minimal spices, no tomato",
        "spice_intensity": "medium",
        "distinguishing_features": [
        ...
        "steps": [
            ...
            },
            {
             ...
             "visible_objects": ["bowl", "rice", "running water"],
             "ingredient_state": {"rice": "being washed, removing excess starch"},
             "expected_visual_features": ["milky water draining off", "rice grains getting cleaner"],
             "expected_audio": "running water, swishing",
             "common_mistakes": ["not washing enough times"],
             "recovery_actions": ["wash until water runs clear"]
            },
            {
             ...
             "visible_objects": ["large pot", "boiling water", "rice", "whole spices", "strainer"],
             "ingredient_state": {"rice": "70-80% cooked — grains elongated but firm in center", "water": "starchy, rolling boil"},
             "expected_visual_features": ["elongated rice grains", "rolling boil", "whole spices floating"],
             "expected_audio": "vigorous bubbling, boiling water",
             "common_mistakes": ["overcooking rice past 70-80%", "not draining immediately"],
             "recovery_actions": ["spread rice on tray to stop cooking", "rinse with cold water"]
            },
            {
             ...
             "visible_objects": ["cooking pot", "chicken", "basmati rice", "ghee"],
             "ingredient_state": {"chicken": "being layered in pot", "basmati rice": "being layered in pot", "ghee": "being layered in pot"},
             "expected_visual_features": ["distinct layers visible in pot"],
             "expected_audio": "placing/spreading sounds",
             "common_mistakes": ["uneven distribution", "pressing down (compacts, blocks steam)"],
             "recovery_actions": ["redistribute evenly", "keep layers loose and fluffy"]
            },
            {
             ...
             "visible_objects": ["pan", "onions", "tomatoes", "spices", "cream"],
             "ingredient_state": {"gravy": "reducing, thickening"},
             "expected_visual_features": ["thick, rich gravy", "oil separating"],
             "expected_audio": "simmering, bubbling",
             "common_mistakes": ["gravy too thin", "not cooking long enough"],
             "recovery_actions": ["cook until oil separates", "reduce on medium heat"]
            }
        ],
    ...
    "Dindigul": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["heavy pan", "cutting board", "kadhai", "strainer"],
        "marination_strategy": "wet curd-based, 1 hr, dairy (yogurt) + heavy black pepper",
        "spice_intensity": "medium-high",
        "distinguishing_features": [
        ...
        "steps": [
            {
             ...
             "visible_objects": ["cutting board", "knife", "chicken"],
             "ingredient_state": {"chicken": "being cut into specified pieces"},
             "expected_visual_features": ["uniform chicken pieces on cutting board"],
             "expected_audio": "chopping/cutting sounds",
             "common_mistakes": ["uneven piece sizes (cook unevenly)"],
             "recovery_actions": ["aim for uniform size pieces"]
            },
            {
            ...
            },
            {
             ...
             "visible_objects": ["cooking pot", "rice", "chicken masala", "wide spatula"],
             "ingredient_state": {"rice": "fully cooked", "chicken": "cooked in masala"},
             "expected_visual_features": ["chicken pieces mixed through rice", "even color distribution"],
             "expected_audio": "tossing, mixing sounds",
             "common_mistakes": ["breaking rice grains by stirring", "uneven distribution"],
             "recovery_actions": ["fold gently with wide spatula", "toss, don't stir"]
            },
            {
    ...
    "Bihari": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["matka (earthen pot) or handi", "kadhai (for mustard oil heating)", "rolling pin (for dough seal)"],
        "marination_strategy": "wet yogurt-based, 1 hr, dairy (yogurt) + mustard oil + minimal spices",
        "spice_intensity": "medium",
        "distinguishing_features": [
        ...
        "steps": [
            ...
            },
            {
             ...
             "visible_objects": ["handi", "mustard oil", "smoke rising"],
             "ingredient_state": {"mustard oil": "heated to smoking point, pungent aroma reducing"},
             "expected_visual_features": ["oil shimmering, light smoke rising"],
             "expected_audio": "oil heating, slight crackling",
             "common_mistakes": ["not heating to smoking point (raw pungent taste remains)"],
             "recovery_actions": ["heat until smoke point, then cool slightly before adding ingredients"]
            },
            {
             ...
             "visible_objects": ["pan", "sliced onions", "whole spices", "oil/ghee"],
             "ingredient_state": {"onions": "frying, turning translucent to golden"},
             "expected_visual_features": ["onions changing color", "whole spices crackling"],
             "expected_audio": "sizzling, crackling of spices",
             "common_mistakes": ["burning onions", "not adding spices at right time"],
             "recovery_actions": ["reduce heat", "add spices when onions are golden"]
            },
            {
             ...
             "visible_objects": ["chicken", "cooking vessel"],
             "ingredient_state": {"chicken": "being processed"},
             "expected_visual_features": ["cooking in progress"],
             "expected_audio": "cooking sounds",
             "common_mistakes": ["timing incorrect"],
             "recovery_actions": ["adjust timing and check frequently"]
            ...
            },
            {
             ...
             "visible_objects": ["cooking pot", "dough/foil/cloth", "lid"],
             "ingredient_state": {"seal": "airtight closure around pot rim"},
             "expected_visual_features": ["sealed pot with no visible gaps", "dough/cloth around rim"],
             "expected_audio": "pressing/sealing sounds",
             "common_mistakes": ["gaps in seal (steam escapes, rice dries out)"],
             "recovery_actions": ["press firmly and patch any gaps"]
            },
            {
    ...
    "Assamese": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["heavy-bottomed pot", "kadhai", "strainer"],
        "marination_strategy": "wet yogurt-based, 1 hr, dairy (yogurt) + mustard oil + turmeric",
        "spice_intensity": "low",
        "distinguishing_features": [
    ...
    "Bombay": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["heavy-bottomed pot", "frying pan (for potatoes)", "kadhai (for onions)", "strainer"],
        "marination_strategy": "wet yogurt-based, 1-2 hrs, dairy (yogurt) + coconut paste + lemon",
        "spice_intensity": "medium",
        "distinguishing_features": [
        ...
        "steps": [
            ...
            },
            {
             ...
             "visible_objects": ["cooking pot", "chicken", "potato", "basmati rice"],
             "ingredient_state": {"chicken": "being layered in pot", "potato": "being layered in pot", "basmati rice": "being layered in pot"},
             "expected_visual_features": ["distinct layers visible in pot"],
             "expected_audio": "placing/spreading sounds",
             "common_mistakes": ["uneven distribution", "pressing down (compacts, blocks steam)"],
             "recovery_actions": ["redistribute evenly", "keep layers loose and fluffy"]
    ...
    "Kashmiri": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["heavy copper degchi", "frying pan (for dry fruits)", "strainer", "mixing bowl"],
        "marination_strategy": "wet yogurt-based, 2 hrs, dairy (yogurt) + Kashmiri chili (color, mild heat) + saffron",
        "spice_intensity": "low",
        "distinguishing_features": [
        ...
        "steps": [
            ...
            },
            {
             ...
             "visible_objects": ["frying pan", "ghee", "dry fruits/nuts"],
             "ingredient_state": {"nuts": "toasting in ghee, turning golden"},
             "expected_visual_features": ["golden nuts, plump raisins"],
             "expected_audio": "gentle sizzling",
             "common_mistakes": ["burning nuts", "not watching closely"],
             "recovery_actions": ["low heat, stir constantly", "remove immediately when golden"]
            },
            {
    ...
    "Mughlai": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["silver-lined degchi", "kadhai", "strainer", "mixing bowl"],
        "marination_strategy": "double marination: yogurt (1 hr) then cream + cashew paste + saffron (30 min)",
        "spice_intensity": "medium",
        "distinguishing_features": [
        ...
        "steps": [
            {
             ...
             "visible_objects": ["chicken", "yogurt", "ginger-garlic paste", "cooking vessel"],
             "ingredient_state": {"chicken": "being processed", "yogurt": "being processed"},
             "expected_visual_features": ["cooking in progress"],
             "expected_audio": "cooking sounds",
             "common_mistakes": ["timing incorrect"],
             "recovery_actions": ["adjust timing and check frequently"]
            },
            {
             ...
             "visible_objects": ["chicken", "saffron", "cooking vessel"],
             "ingredient_state": {"chicken": "being processed", "saffron": "being processed"},
             "expected_visual_features": ["cooking in progress"],
             "expected_audio": "cooking sounds",
             "common_mistakes": ["timing incorrect"],
             "recovery_actions": ["adjust timing and check frequently"]
    ...
    "Bamboo": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["fresh bamboo trunk (defining vessel)", "wood fire setup", "knife (for bamboo prep)"],
        "marination_strategy": "dry/minimal, 30 min, basic spices (turmeric, red chili, ginger-garlic)",
        "spice_intensity": "low",
        "distinguishing_features": [
        ...
        "steps": [
            {
             ...
             "visible_objects": ["bamboo trunk", "chicken", "rice", "spices"],
             "ingredient_state": {"bamboo": "fresh, cleaned, ready for stuffing"},
             "expected_visual_features": ["ingredients packed inside bamboo cavity"],
             "expected_audio": "packing/stuffing sounds",
             "common_mistakes": ["overstuffing", "not sealing properly"],
             "recovery_actions": ["leave room for steam", "seal with banana leaf/dough"]
            },
            {
            ...
            },
            {
             ...
             "visible_objects": ["bamboo on fire", "wood fire", "support structure"],
             "ingredient_state": {"contents": "cooking inside sealed bamboo via fire heat"},
             "expected_visual_features": ["bamboo charring on outside", "smoke rising", "fire glowing"],
             "expected_audio": "crackling fire, occasional hissing",
             "common_mistakes": ["not rotating (one side burns)", "fire too intense"],
             "recovery_actions": ["rotate bamboo every 10 min", "control fire distance"]
            },
            {
    ...
    "Degi": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["large deg (cauldron)", "stock pot (for yakhni)", "kadhai (for onions)", "strainer"],
        "marination_strategy": "yakhni-based, yogurt marinade, heavy ghee, designed for bulk cooking",
        "spice_intensity": "medium",
        "distinguishing_features": [
    ...
    "Matka": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["clay matka/handi (defining vessel)", "frying pan (for pre-cooking)", "strainer", "rolling pin (for dough seal)"],
        "marination_strategy": "wet yogurt-based, 1 hr, dairy (yogurt) + standard spices",
        "spice_intensity": "medium",
        "distinguishing_features": [
        ...
        "steps": [
            {
             ...
             "visible_objects": ["clay matka", "water", "oil"],
             "ingredient_state": {"matka": "soaked in water, being greased with oil"},
             "expected_visual_features": ["wet clay pot", "oil coating inside"],
             "expected_audio": "water draining, oil spreading",
             "common_mistakes": ["not soaking long enough (matka cracks)", "using unsoaked matka"],
             "recovery_actions": ["soak minimum 30 min", "grease interior generously"]
            },
            {
            ...
            },
            {
             ...
             "visible_objects": ["clay matka", "chicken", "rice", "spices"],
             "ingredient_state": {"chicken": "being layered inside matka", "basmati rice": "being layered inside matka", "saffron": "being layered inside matka"},
             "expected_visual_features": ["layered contents visible in clay pot"],
             "expected_audio": "placing/layering sounds",
             "common_mistakes": ["overfilling", "not leaving headspace for steam"],
             "recovery_actions": ["fill to 3/4 capacity"]
            },
            {
    ...
    "Tandoori": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["tandoor or oven (for grilling)", "heavy pot (for biryani dum)", "strainer", "grill rack"],
        "marination_strategy": "wet yogurt-based tandoori, 2 hrs, dairy (yogurt) + Kashmiri chili + mustard oil + lemon",
        "spice_intensity": "medium-high",
        "distinguishing_features": [
        ...
        "steps": [
            ...
            },
            {
             ...
             "visible_objects": ["tandoor/oven/grill", "marinated chicken", "grill rack/tray"],
             "ingredient_state": {"chicken": "charring and cooking through, developing smoky crust"},
             "expected_visual_features": ["charred reddish-brown chicken", "smoke rising", "juices dripping"],
             "expected_audio": "sizzling on grill, occasional crackling",
             "common_mistakes": ["uneven cooking", "too far from heat (no char)", "drying out"],
             "recovery_actions": ["rotate pieces frequently", "baste with marinade/oil"]
            },
            {
            ...
            },
            {
             ...
             "visible_objects": ["cooking pot", "basmati rice", "saffron", "ghee"],
             "ingredient_state": {"basmati rice": "being layered in pot", "saffron": "being layered in pot", "ghee": "being layered in pot"},
             "expected_visual_features": ["distinct layers visible in pot"],
             "expected_audio": "placing/spreading sounds",
             "common_mistakes": ["uneven distribution", "pressing down (compacts, blocks steam)"],
             "recovery_actions": ["redistribute evenly", "keep layers loose and fluffy"]
    ...
    "Arabic": {
        ...
        "protein": "chicken",
        "utensil_hierarchy": ["roasting tray", "large serving platter", "pot (for rice)", "frying pan (for nuts)"],
        "marination_strategy": "wet yogurt-based, 2 hrs, dairy (yogurt) + baharat spice blend + lemon",
        "spice_intensity": "medium",
        "distinguishing_features": [
        ...
        "steps": [
            ...
            },
            {
             ...
             "visible_objects": ["basmati rice", "saffron", "cardamom", "cooking vessel"],
             "ingredient_state": {"basmati rice": "being processed", "saffron": "being processed"},
             "expected_visual_features": ["cooking in progress"],
             "expected_audio": "cooking sounds",
             "common_mistakes": ["timing incorrect"],
             "recovery_actions": ["adjust timing and check frequently"]
            ...
            },
            {
             ...
             "visible_objects": ["large serving platter", "rice", "chicken", "garnishes"],
             "ingredient_state": {"rice": "fully cooked, aromatic", "chicken": "roasted/grilled, golden"},
             "expected_visual_features": ["chicken arranged on rice bed", "garnished with nuts and herbs"],
             "expected_audio": "plating sounds",
             "common_mistakes": ["messy presentation"],
             "recovery_actions": ["arrange chicken pieces prominently on rice"]
            },
            {
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="CulinaryVLM — Generate all canonical recipes offline",
    )
    ...
    for category, recipe in sorted(ALL_RECIPES.items()):
        ...
        if filepath.exists() and not args.force:
            logger.info(f"  ⊘ {filename:25s} — already exists, skipping (use --force to overwrite)")
            skipped += 1
            continue
        elif filepath.exists() and args.force:
            logger.info(f"  ♻ {filename:25s} — overwriting (--force)")

        # Ensure schema_version is always present
        recipe.setdefault("schema_version", "2.0")

        # Atomic write: temp file → os.replace so old file is never lost
        import tempfile
