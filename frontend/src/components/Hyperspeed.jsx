  ...
  useEffect(() => {
    ...
    class App {
      constructor(container, options = {}) {
        ...
        // Patch: postprocessing@6 reads getContextAttributes().alpha which
        // can return null in newer Three.js versions, causing a crash.
        const gl = this.renderer.getContext();
        const origGetCtxAttrs = gl.getContextAttributes.bind(gl);
        gl.getContextAttributes = () => origGetCtxAttrs() || { alpha: true };
